$(function () {
    ...
    var countryInput = $(document).find('#profile-country');
    $.each(countries, function (index, country) {
        var flag_name = window.location.origin + "/css/flags/" + country.code + ".png";
        var obj = `<option data-country-code="` + country.code + `" value="` + country.name + `" style=" background-image: url('`+flag_name+`')"`+` data-style=" background-image: url('`+flag_name+`')"`+`>`;
        countryInput.append(obj + country.name + `</option>`);
    });
    //generate country-select ul and add flags to each list
    $( function() {
        $.widget( "custom.iconselectmenu", $.ui.selectmenu, {
        options: {
            appendTo: $("div#country-select-lists")
        },
        ...
        $( "#profile-country" )
        .iconselectmenu();
        // $( "#profile-country" ).selectmenu( "selectmenuchange", function( event, ui ) {
        //     console.log("sdfsdfprofile");
        // } );
    } );
    //add flags
    var indexOption = 0;
