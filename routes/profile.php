 ...
 * Category Routes
 */
Route::group(array('prefix' => 'profile', 'middleware'=>'auth'), function () {
    ...
    Route::get('/time_line', array('uses'=>'profile\ProfileController@getTimeLine', 'as'=>'profile.time_line'));
    Route::get('/friend_list', array('uses'=>'profile\ProfileController@getFriendList', 'as'=>'profile.friend_list'));
