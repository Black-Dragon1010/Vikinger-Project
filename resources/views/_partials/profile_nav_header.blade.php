...
<nav class="section-navigation">
      ...
      <div id="section-navigation-slider" class="section-menu">
        ...
        active
        @endif
        " href="{!! route('profile.index', ['user_id'=>$user->id]) !!}">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item 
        @if(Route::is('profile.time_line'))
        active
        @endif
        " href="{!! route('profile.time_line', ['user_id'=>$user->id]) !!}">
          <!-- SECTION MENU ITEM ICON -->
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item 
        @if(Route::is('profile.friend_list'))
        active
        @endif
        " href="{!! route('profile.friend_list', ['user_id'=>$user->id]) !!}">
          <!-- SECTION MENU ITEM ICON -->
